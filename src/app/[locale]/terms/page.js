...
/* Wave 1 — لا وصف Meta على مستوى الصفحة عمدًا: terms.intro نصّ مسوّدة يعلن أن النسخة
...
export async function generateMetadata({ params }) { const { locale } = await params; const t = await getTranslations({ locale, namespace: 'terms' }); return { title: t('heading'), alternates: altLangs(locale, '/terms') }; }
